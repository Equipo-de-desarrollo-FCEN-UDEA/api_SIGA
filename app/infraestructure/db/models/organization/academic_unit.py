...
class AcademicUnit(BaseExposableModel):
    ...
    academic_unit_type = relationship(
        'AcademicUnitType', back_populates='academic_units', lazy='selectin',
    )
    ...
    user_rol_academic_units = relationship(
        'UserRolAcademicUnit', back_populates='academic_unit',
    )

    applications = relationship('Application', back_populates='academic_unit')
    user_application_academic_units = relationship(
        'UserApplicationAcademicUnit', back_populates='academic_unit',
    )

...
api_router.include_router(
    user_rol_academic_rol.router,
    prefix='/user_rol_academic_unit', tags=['user_rol_academic_unit'],
)
api_router.include_router(student.router, prefix='/student', tags=['student'])
api_router.include_router(
    professor.router, prefix='/professor', tags=['professor'],
)
api_router.include_router(
    administrative.router,
    prefix='/administrative', tags=['administrative'],
)


api_router.include_router(
    academic_unit_type.router,
    prefix='/academic_unit_type', tags=['academic_unit_type'],
)
api_router.include_router(
    academic_unit.router,
    prefix='/academic_unit', tags=['academic_unit'],
)

# voting
api_router.include_router(voting.router, prefix='/voting', tags=['voting'])
api_router.include_router(
    vote_type.router, prefix='/vote_type', tags=['vote_type'],
)
